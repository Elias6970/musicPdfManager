...
class ClassificationJob(SQLModel):
    ...
    source_files: list[str] = Field(default_factory=list, description="A list of the PDF filenames that were used as a source for generating the classfied documents. They are going to be removed during the classification process")
