...
# TODO
`Add a desciption about how to classify scores`


`Before opening score classifier add a window to select the pieces to classify. This window will have a Search_score_bar and a QComboBox with scroll bar`
